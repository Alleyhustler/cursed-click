/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="c_widget"></div>
        <script src="https://patentghost.neocities.org/guest/comment-widget.js"></script>
...
const s_stylePath = 'https://patentghost.neocities.org/guest/comment-widget.css';
const s_formId = '1FAIpQLSf0ZbEEL2E9fGiooWkuQ9ZAF1UQg_-ME5t7q6I1mjA8wfkrxA';
const s_nameId = '1746391075';
const s_websiteId = '1429153045';
const s_textId = '1334768526';
const s_moderatedId = '720689751'; // The Moderated field ID
const s_pageId = '752963416';
const s_replyId = '354561602';
const s_sheetId = '1xcrmZdUDS6KW2K6duVs78PURaDWJsNDZ5-ffv0wtq_g';
...
const s_widgetTitle = 'What will you leave behind?';
const s_nameFieldLabel = 'Your Name';
const s_websiteFieldLabel = 'Your Site (optional)';
const s_textFieldLabel = 'Your Words';
const s_submitButtonLabel = 'Offer';
const s_loadingText = 'Gathering momentos...';
const s_noCommentsText = 'No souls linger here...';
const s_closedCommentsText = 'And the gate was closed for a time.';
const s_websiteText = 'Coordinates'; // The links to websites left by users on their comments
...
const s_expandRepliesText = 'Reveal';
...
function createComment(data) {
    ...
    name.innerText = 'Our Honored Guest'; // Change 'Guest' to whatever you want
}
    ...
    if(data.Moderated == false) {
    text.innerText = 'This message lingers in between... for now.'; // Change this value to whatever you want
}
